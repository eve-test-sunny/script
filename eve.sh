...
git clone https://github.com/eve-test-sunny/device_xiaomi_sunny.git -b lineage-22 device/xiaomi/sunny
...
# git clone https://github.com/rising-source-mod/android_vendor_lineage.git --depth 1 -b 15 vendor/lineage
